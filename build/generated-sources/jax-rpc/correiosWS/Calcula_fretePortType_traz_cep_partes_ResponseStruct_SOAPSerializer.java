...
public class Calcula_fretePortType_traz_cep_partes_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public Calcula_fretePortType_traz_cep_partes_ResponseStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        correiosWS.Calcula_fretePortType_traz_cep_partes_ResponseStruct instance = new correiosWS.Calcula_fretePortType_traz_cep_partes_ResponseStruct();
        correiosWS.Calcula_fretePortType_traz_cep_partes_ResponseStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_return_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new correiosWS.Calcula_fretePortType_traz_cep_partes_ResponseStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        correiosWS.Calcula_fretePortType_traz_cep_partes_ResponseStruct instance = (correiosWS.Calcula_fretePortType_traz_cep_partes_ResponseStruct)obj;
