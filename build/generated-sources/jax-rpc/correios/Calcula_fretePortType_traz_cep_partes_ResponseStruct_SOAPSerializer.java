...
public class Calcula_fretePortType_traz_cep_partes_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        correios.Calcula_fretePortType_traz_cep_partes_ResponseStruct instance = new correios.Calcula_fretePortType_traz_cep_partes_ResponseStruct();
        correios.Calcula_fretePortType_traz_cep_partes_ResponseStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_return_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new correios.Calcula_fretePortType_traz_cep_partes_ResponseStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        correios.Calcula_fretePortType_traz_cep_partes_ResponseStruct instance = (correios.Calcula_fretePortType_traz_cep_partes_ResponseStruct)obj;
