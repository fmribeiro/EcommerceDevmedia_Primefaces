...
public class Calcula_fretePortType_Stub
    ...
    implements correios.Calcula_fretePortType {
    ...
    public java.lang.String calcula_frete(java.lang.String frete)
        ...
        try {
            ...
            correios.Calcula_fretePortType_calcula_frete_RequestStruct _myCalcula_fretePortType_calcula_frete_RequestStruct =
                new correios.Calcula_fretePortType_calcula_frete_RequestStruct();
            ...
            correios.Calcula_fretePortType_calcula_frete_ResponseStruct _myCalcula_fretePortType_calcula_frete_ResponseStruct = null;
            Object _responseObj = _state.getResponse().getBody().getValue();
            if (_responseObj instanceof SOAPDeserializationState) {
                _myCalcula_fretePortType_calcula_frete_ResponseStruct =
                    (correios.Calcula_fretePortType_calcula_frete_ResponseStruct)((SOAPDeserializationState)_responseObj).getInstance();
            } else {
                _myCalcula_fretePortType_calcula_frete_ResponseStruct =
                    (correios.Calcula_fretePortType_calcula_frete_ResponseStruct)_responseObj;
            }
    ...
    public java.lang.String traz_cep(java.lang.String cep)
        ...
        try {
            ...
            correios.Calcula_fretePortType_traz_cep_RequestStruct _myCalcula_fretePortType_traz_cep_RequestStruct =
                new correios.Calcula_fretePortType_traz_cep_RequestStruct();
            ...
            correios.Calcula_fretePortType_traz_cep_ResponseStruct _myCalcula_fretePortType_traz_cep_ResponseStruct = null;
            Object _responseObj = _state.getResponse().getBody().getValue();
            if (_responseObj instanceof SOAPDeserializationState) {
                _myCalcula_fretePortType_traz_cep_ResponseStruct =
                    (correios.Calcula_fretePortType_traz_cep_ResponseStruct)((SOAPDeserializationState)_responseObj).getInstance();
            } else {
                _myCalcula_fretePortType_traz_cep_ResponseStruct =
                    (correios.Calcula_fretePortType_traz_cep_ResponseStruct)_responseObj;
            }
    ...
    public java.lang.String traz_cep_partes(java.lang.String cep)
        ...
        try {
            ...
            correios.Calcula_fretePortType_traz_cep_partes_RequestStruct _myCalcula_fretePortType_traz_cep_partes_RequestStruct =
                new correios.Calcula_fretePortType_traz_cep_partes_RequestStruct();
            ...
            correios.Calcula_fretePortType_traz_cep_partes_ResponseStruct _myCalcula_fretePortType_traz_cep_partes_ResponseStruct = null;
            Object _responseObj = _state.getResponse().getBody().getValue();
            if (_responseObj instanceof SOAPDeserializationState) {
                _myCalcula_fretePortType_traz_cep_partes_ResponseStruct =
                    (correios.Calcula_fretePortType_traz_cep_partes_ResponseStruct)((SOAPDeserializationState)_responseObj).getInstance();
            } else {
                _myCalcula_fretePortType_traz_cep_partes_ResponseStruct =
                    (correios.Calcula_fretePortType_traz_cep_partes_ResponseStruct)_responseObj;
            }
    ...
    public void _initialize(InternalTypeMappingRegistry registry) throws Exception {
        ...
        ns1_myCalcula_fretePortType_calcula_frete_RequestStruct_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, correios.Calcula_fretePortType_calcula_frete_RequestStruct.class, ns1_calcula_frete_TYPE_QNAME);
        ns1_myCalcula_fretePortType_traz_cep_partes_RequestStruct_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, correios.Calcula_fretePortType_traz_cep_partes_RequestStruct.class, ns1_traz_cep_partes_TYPE_QNAME);
        ns1_myCalcula_fretePortType_traz_cep_RequestStruct_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, correios.Calcula_fretePortType_traz_cep_RequestStruct.class, ns1_traz_cep_TYPE_QNAME);
        ns1_myCalcula_fretePortType_calcula_frete_ResponseStruct_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, correios.Calcula_fretePortType_calcula_frete_ResponseStruct.class, ns1_calcula_freteResponse_TYPE_QNAME);
        ns1_myCalcula_fretePortType_traz_cep_partes_ResponseStruct_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, correios.Calcula_fretePortType_traz_cep_partes_ResponseStruct.class, ns1_traz_cep_partesResponse_TYPE_QNAME);
        ns1_myCalcula_fretePortType_traz_cep_ResponseStruct_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, correios.Calcula_fretePortType_traz_cep_ResponseStruct.class, ns1_traz_cepResponse_TYPE_QNAME);
    }
    
    private static final javax.xml.namespace.QName _portName = new QName("http://www.maniezo.com.br/", "calcula_fretePort");
    private static final int calcula_frete_OPCODE = 0;
    private static final int traz_cep_OPCODE = 1;
