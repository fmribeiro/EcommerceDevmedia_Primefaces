...
public class AdminAuthFilter implements Filter {
    ...
    @Inject
    private AdminLoginFace loginBean;
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if(BasicSessionBean.debug){
            System.out.println("Debug URL"+url);
        }
        try {
            if(loginBean.isAdminUserLogged() || url.contains("/admin/loginerr.faces") 
                    || url.contains("/admin/index.faces")|| url.endsWith("/admin")){
